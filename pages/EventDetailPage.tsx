...
const EventDetailPage: React.FC = () => {
  ...
  // Badge for registration status (same style as EventCard)
        ...
        <div className="p-6 sm:p-8 md:p-10">
          <div className="md:flex justify-between items-start">
            <div className='flex-grow'>
                ...
                <h1 className="mt-2 text-3xl sm:text-4xl font-extrabold text-neutral-900 tracking-tight flex items-center">
                  {event.title}
                  {/* Show status badge for students only */}
                  {currentUser && (currentUser.role === UserRole.STUDENT || currentUser.role === 'STUDENT') && statusBadge(registrationStatus)}
                </h1>
